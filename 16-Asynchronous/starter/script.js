...
// PART 1: Rewrite this to async/await
...
const loadAll = async function (imgArr) {
  try {
    // Loop over array and call createImage on each image
    const imgs = imgArr.map(img => createImage(img));
    console.log(imgs);

    // Use Promise combinator to get images from array
